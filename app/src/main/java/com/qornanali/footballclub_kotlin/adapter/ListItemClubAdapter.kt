...
class ListItemClubAdapter(val context: Context, val list: ArrayList<ItemClub> = ArrayList<ItemClub>(), val onItemClickListener: OnItemClickListener<ItemClub>) : RecyclerView.Adapter<ItemClubHolder>() {
